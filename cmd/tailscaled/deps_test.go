...
func TestOmitServiceClientPrefs(t *testing.T) {
	...
	deptest.DepChecker{
		...
		BadDeps: map[string]string{
			"github.com/metacubex/tailscale/feature/serviceclientprefs": msg,
		},
	}.Check(t)
}
...
func TestOmitSyslog(t *testing.T) {
	...
	deptest.DepChecker{
		...
		BadDeps: map[string]string{
			"log/syslog":                   msg,
			"github.com/metacubex/tailscale/feature/syslog": msg,
		},
	}.Check(t)
}
...
func TestOmitBird(t *testing.T) {
	deptest.DepChecker{
		...
		OnDep: func(dep string) {
			switch dep {
			case "github.com/metacubex/tailscale/chirp", "github.com/metacubex/tailscale/feature/bird":
...
func TestDBusDisabledByDefault(t *testing.T) {
	deptest.DepChecker{
		GOOS:   "linux",
		GOARCH: "amd64",
		Tags:   "ts_omit_systray,ts_omit_ssh,ts_include_cli",
		OnDep: func(dep string) {
